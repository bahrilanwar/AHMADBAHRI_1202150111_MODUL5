...
public class MainActivity extends AppCompatActivity {
    ...
    //button add pada screen
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                final AlertDialog dialog = mBuilder.create();
                 //set button untuk get data
                mButton.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        if (cek()) {
                            Snackbar.make(view, "Isi Dulu Bre Bre", Snackbar.LENGTH_LONG)
        ...
        //fitur swipe pada list untuk menghapus
        ...
        // membuat option menu untuk mengganti warna
    @Override
    ...
    // get dan set warna pada view nya
    @Override
    ...
    // Database setting CRUD panggil(get data)
    @Override
